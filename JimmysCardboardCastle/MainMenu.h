...
public:
	virtual void initialize()
	{
		...
		add(new Button(66+20, 275+10, 139, 22, "images/dev/LoadGameButton.png", startCurrentLevel));
		add(new Button(66+20, 250+10, 161, 22, "images/dev/HowToPlayButton.png", startWorld<HowToPlay>));
		add(new Button(60+20, 225+10, 104, 22, "images/dev/Options.png", startWorld<TestWorld>));
		add(new Button(66+20, 200+10, 91, 24, "images/dev/CreditsButton.png", startWorld<CreditsScreen>));
