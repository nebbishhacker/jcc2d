...
public:
	virtual void initialize()
	{
		...
		add(new Background(0, -100, 2000, 1600, "images/dev/lavaRoom_bgm.png", -100, 0.5, 0.25));

		std::shared_ptr<TileSheet> tileSheet(new TileSheet(32, 32, 4, 4, "images/dev/JCC_LavaRoomPlat.png"));
