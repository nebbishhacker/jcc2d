...
public:
	...
	Robert_proj(double x, double y, bool flip) : PhysicsSprite("images/spr_dboyproj.png")
	{
		setPosition(x, y);
	...
	{		
		...
		world->groups["robertscryptonite"].add(this);
	};
	void update()
	{
		// Set the velocity //
		...
		// Check if the box should collide with Robert //
		// If it should be then it will moveCollide with Robert //
